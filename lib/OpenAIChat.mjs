...
export class OpenAIChat {
  constructor(isInteractiveMode, rolePrompt, commandPrompt) {
    ...
    const AZURE_API_VERSION =
      process.env.AZURE_API_VERSION || "2023-12-01-preview";
    ...
    this._url = `${OPENAI_API_BASE}/openai/deployments/${OPENAI_API_MODEL_NAME}/chat/completions?api-version=${AZURE_API_VERSION}`;
  ...
  async _sendCompletionRequest() {
    ...
    try {
      ...
      if (err.name === "AbortError") {
        this.error = "Timed out. Type '/r' to retry.";
